...
from utils.save_functions import save_metrics, save_total_trial_binary_segmentation
...
def IS2D_main(args) :
    ...
    save_metrics(args, test_results, model_dirs, args.final_epoch, args.current_trial)
...
if __name__=='__main__' :
    ...
    if args.train_data_type == 'ISIC2018':
        for test_data_type in ['ISIC2018', 'PH2']:
            ...
            save_total_trial_binary_segmentation(args)
